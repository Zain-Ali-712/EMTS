            ...
            <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative z-10">
              ...
              <div className="flex flex-col md:hidden overflow-y-auto">
                ...
                <div className="p-4 flex flex-col">
                  <div className="relative h-64 rounded-xl overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200">
                    <motion.img
                    ...
                    <button
                      onClick={prevImage}
                      className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-110 border border-gray-200"
                    >
                    ...
                    <button
                      onClick={nextImage}
                      className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-110 border border-gray-200"
                    >
                      <svg className="w-4 h-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="hidden md:flex flex-1">
                ...
                {/* Description */}
                <div className="md:w-2/5 p-6 border-l border-gray-200 bg-white/70 backdrop-blur-sm">
